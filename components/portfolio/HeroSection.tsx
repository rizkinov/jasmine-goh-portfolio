...
const stickyNotes: StickyNote[] = [
    ...
    { id: 4, type: 'image', imageUrl: 'https://fpsputfmlbzfifeillss.supabase.co/storage/v1/object/public/media/uploads/1769248977897-08rj7l.png', color: 'bg-purple-100', rotateClass: 'rotate-2', topClass: 'top-[52%] md:top-[25%]', rightClass: 'right-[35%] md:right-[30%]', imageScale: 'scale-50' },
