...
const stickyNotes: StickyNote[] = [
    ...
    { id: 2, text: 'scroll down', color: 'bg-pink-100', rotateClass: 'rotate-3', topClass: 'top-[74%] md:top-[55%]', rightClass: 'right-[65%] md:right-[50%]' },
    ...
    { id: 5, text: '🥁', color: 'bg-green-100', rotateClass: '-rotate-4', topClass: 'top-[66%] md:top-[45%]', rightClass: 'right-[15%] md:right-[5%]' },
